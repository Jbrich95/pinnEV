...
#' model<-quant.NN.train(Y_train, Y_test,X_train,  type="MLP",link="identity",tau=0.5,n.ep=50,
...
quant.NN.train=function(Y_train, Y_test = NULL,X_train, type="MLP",link="identity",tau=NULL,
